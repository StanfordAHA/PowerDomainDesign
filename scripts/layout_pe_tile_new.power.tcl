...
set init_mmmc_file ../../scripts/mmmc.power.tcl
...
read_power_intent -1801 ../../scripts/upf.tcl
commit_power_intent
write_power_intent  -1801 upf2.tcl
...
#0.576 = row height
set height [expr ceil(55/0.576)*0.576] 
...
modifyPowerDomainAttr AON -box 27 0 42 10
...
#addPowerSwitch -column \-powerDomain TOP  \-leftOffset 16  -bottomOffset 0 \-horizontalPitch 24 \-checkerBoard \-loopBackAtEnd -enableNetOut ps_en/O -rightOffset 10
addPowerSwitch -column \-powerDomain TOP  \-leftOffset 6  -bottomOffset 1 \-horizontalPitch 24 \-checkerBoard \-loopBackAtEnd -enableNetOut ps_en/O -topOffset 1
